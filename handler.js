...
—◉ *Contacto para apelaciones:* wa.me/201024480189
╚═════════════════════════╝
               `.trim();
              m.reply(messageText);
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '[ ⚠ ] دعوه - للجروب', body: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/BS48T3k00FY672UVhG3rFu'}}}}, aa);
