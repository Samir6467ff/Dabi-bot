...
conn.welcome = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ 𝕯𝖆𝖇𝖎 ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @subject*\n*│──────────────*\n*│ꪶ→ @user*\n*│ꪶ→ايه الاخبار معاك دابي بوت🔷👑* \n*│*\n*│ꪶ→ وصف✨ المجموعه:*\n\n@desc\n\n*│*\n*│ꪶ→ واتمنى انك تتبسط معنا🔥 بالمجموعه*\n*╰──────────────╯*'
conn.bye = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ 𝕯𝖆𝖇𝖎 ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @user*\n¡*باي من غير سلام 🤷⛔*\n*╰──────────────╯*'
...
setInterval(async () => {
  ...
  const bio = `🤖 مده النشاط: ${uptime} ┃ 👑 من صنع هاشيرا و بوص┃ 🔗 جروب المطورين: https://chat.whatsapp.com/BS48T3k00FY672UVhG3rFu`;
